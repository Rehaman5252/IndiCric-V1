        ...
        <>
            ...
            {showAdDialog && (
                <AdDialog
                    ...
                    duration={adLibrary.resultsAd?.duration || 7}
                    skippableAfter={adLibrary.resultsAd?.skippableAfter || 5}
                    adTitle={adLibrary.resultsAd?.title || "Ad"}
                    adType={adLibrary.resultsAd?.type || "image"}
                    adUrl={adLibrary.resultsAd?.url || ""}
                    adHint={adLibrary.resultsAd?.hint}
                >
                    <p className="text-xs text-muted-foreground mt-2">
                        Watch this ad to review your answers. This is a one-time action per quiz.
                    </p>
                </AdDialog>
            )}
